...
ANSWERS_PATH = os.path.join(BASE_DIR, "knowledge_base", "intent_answers_agentic_rag.json")
VECTOR_PATH = os.path.join(BASE_DIR, "embeddings", "intent_vectors_openai_agentic_rag.json")
