...
FILL_COUNTRY_HEADERS=[
    ...
    ("fill", "收件人电话", "phone",""),	
    ("fixed","收件人邮箱","recipient_email_address","128903@qq.com"),
    ("fixed","收件人税号","recipient_tax_ID","TX9980"),
    ("blank","收件人公司","recipient_company",""),
    ("fixed", "收件人国家","recipient_country","沙特阿拉伯"),
    ("fill", "收件人省/州", "recipient_province_state",""),
    ("fill","收件人城市","recipient_city",""),
    ("fill","收件人邮编", "postal_code",""),
    ("fill","收件人地址","address", ""),
    ("blank","收件人门牌号","recipient_address",""),	
    ("blank","收件人短地址","recipient_short_address",""),
    ...
    ("blank","CSP","csp", ""),
    ("blank","包装尺寸【长】cm", "packaging_dimensions_length_cm",""),	
